...
AURA_MAX_API_CALLS_PER_CYCLE = int(os.environ.get("AURA_MAX_API_CALLS_PER_CYCLE", "1"))
AURA_SKIP_LLM_WHEN_MONITORING = _env_bool("AURA_SKIP_LLM_WHEN_MONITORING", True)
AURA_COMPACT_CONTEXT = _env_bool("AURA_COMPACT_CONTEXT", True)
